...
import { MaskedVideoLogo, MaskedVideoLogoHandle } from "./MaskedVideoLogo";
...
export default function AppleM5Hero({ videoSrc, children }: Props) {
    const sectionRef = useRef<HTMLDivElement>(null);
    const maskLogoRef = useRef<MaskedVideoLogoHandle>(null);
    ...
    useLayoutEffect(() => {
        ...
        const ctx = gsap.context(() => {
            ...
            const overflowMultiplier = isMobile ? 1880 : 90;
    ...
    return (
        <section ref={sectionRef} className="relative bg-black">
            <div className="h-screen overflow-hidden relative transition-opacity duration-700"
                style={{ opacity: isVideoReady ? 1 : 0 }}
            >

                <iframe
                    ref={videoRef}
                    // Importante: background=1 oculta controles y fuerza el modo cover de Vimeo
             ...
             pointer-events-none"
                    style={{
                        // Forzamos el aspecto 16:9 calculado sobre el alto de la pantalla
                        width: '177.77vh',
                        height: '100dvh',
                        objectFit: 'cover'
                    }}
    ...
    // max-w-[90%] para móvil (ajusta el % o px a tu gusto)
    // md:max-w-[680px] para desktop
    className="w-full h-full max-w-[93%] md:max-w-[530px]"
    fill="white"
>
<path d="M165.1,28.7c4.4,0,7.3,3,7.3,7.3v31c0,4.4-3,7.3-7.3,7.3h-89.1c-9.3,0-15.2,8.5-15.2,17.1v60.1c0,8.8,5.9,16.9,15.2,16.9h89.1c4.4,0,7.3,3,7.3,7.3v31.3c0,4.4-3,7.3-7.3,7.3h-89.1c-34.9,0-62.3-29.3-62.3-63.7v-57.9c0-34.5,27.2-64,62.3-64,0,0,89.1,0,89.1,0Z"/>
  ...
  <path d="M1066.7,212l-71.3-100c-1.5-2.2-5-1-5,1.5v96.8c0,1.5-1.3,2.7-2.7,2.7h-31.9c-3.9,0-7-3.1-7-7V32.9c0-3.9,3.1-7,7-7h28.8c.9,0,1.7.4,2.2,1.2l71.3,100.3c1.5,2.2,5,1,5-1.5V28.8c0-1.5,1.3-2.7,2.7-2.7h31.9c3.9,0,7,3.1,7,7v173.1c0,3.9-3.1,7-7,7h-28.8c-.9,0-1.7-.4-2.2-1.2h0Z"/>
                ...
                <div
                    ref={textRef}
                    className="absolute inset-0 flex items-center justify-center text-white text-center px-6 pointer-events-none"
                >
                    {children}
                </div>
            </div>
