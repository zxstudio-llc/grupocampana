...
export interface MaskedVideoLogoHandle {
...
export const MaskedVideoLogo = forwardRef<
  MaskedVideoLogoHandle,
  Props
>(({ videoSrc }, ref) => {
...
MaskedVideoLogo.displayName = "MaskedVideoLogo";